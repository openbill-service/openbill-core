...
4. Для каждого нового или изменённого `*.md` поддерживать русскую версию `*.ru.md`.
5. Добавлять перекрёстные ссылки между языковыми версиями в начале файла:
   - в английской версии: `Русская версия: [<file>.ru.md](<file>.ru.md)`
   - в русской версии: `English version: [<file>.md](<file>.md)`
